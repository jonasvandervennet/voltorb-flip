...
<img src="docs/initial_hint.png" alt="Initial hint provided by the Voltorb Flip solver." width="60%"/>
...
<img src="docs/board_after_hint.png" alt="In this case the golden question mark was covering a 3." width="49%"/><img src="docs/updated_vtbf_solver.png" alt="The follow-up suggestion leaves a 2x2 region to guess in." width="49%"/>
